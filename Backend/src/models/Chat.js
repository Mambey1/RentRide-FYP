...
//     },
//     vehicleName: String,
//     // Stores the actual vehicle owner's user ID for reliable role display
//     // Set at chat creation — works for both user-listed and admin-listed vehicles
//     vehicleOwnerId: {
//       type: mongoose.Schema.Types.ObjectId,
//       ref: "User",
//       default: null,
...
const chatSchema = new mongoose.Schema(
  {
    chatType: {
      type: String,
      enum: ["vehicle", "support", "booking", "direct"],
      required: true,
    },
    participants: [
      {
