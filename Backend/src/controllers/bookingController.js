...
//     // Send a push notification via email as well (optional)
//     // You can also integrate with Firebase Cloud Messaging here if needed

//     console.log(`✅ Payment notification sent to user ${booking.user.email} for booking ${booking.confirmationCode}`);

//     res.status(200).json({
//       success: true,
//       message: "Booking approved successfully. Payment notification sent to customer.",
//       data: {
//         booking: {
//           id: booking._id,
//           status: booking.status,
