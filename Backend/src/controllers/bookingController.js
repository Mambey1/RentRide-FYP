...
// // //     // When cancelled, make vehicle available again
// // //     if (booking.vehicleType === "user") {
// // //       await UserVehicle.findByIdAndUpdate(booking.vehicle, {
// // //         status: "active",
// // //         isListed: true,
// // //       });
// // //       console.log("✅ User vehicle status updated to active (cancelled)");
// // //     } else if (booking.vehicleType === "admin") {
// // //       await Vehicle.findByIdAndUpdate(booking.vehicle, {
// // //         status: "Available",
// // //       });
// // //     }
...
// // // // Approve booking (admin) - UPDATED with payment notification
...
// // // //     booking.expiresAt = new Date(Date.now() + 48 * 60 * 60 * 1000); // 48 hours to complete payment
// // // //     booking.paymentStatus = "pending"; // Ensure payment is pending
// // // //     await booking.save();
...
// // // //     // Use the enhanced notification with payment action
...
// // // //     // Also create a separate payment required notification (optional)
...
// // // //     if (booking.vehicleType === "user") {
// // // //       try {
// // // //         // Change to "booked" status instead of just "booked"
// // // //         await UserVehicle.findByIdAndUpdate(booking.vehicle, {
// // // //           status: "booked",
// // // //           isListed: false,
// // // //         });
...
// // // // Approve booking (admin) - Ensure vehicle status is set to "booked"
// // // export const approveBooking = async (req, res) => {
// // //   try {
// // //     const { id } = req.params;
// // //     const adminId = req.user.id;
...
// // //       // If expired, make vehicle available again
// // //       if (booking.vehicleType === "user") {
// // //         await UserVehicle.findByIdAndUpdate(booking.vehicle, {
// // //           status: "active",
// // //           isListed: true,
...
// // //     } else if (status === "completed") {
// // //       booking.endDate = new Date();
// // //       // When booking is completed, make vehicle available again
// // //       if (booking.vehicleType === "user") {
// // //         await UserVehicle.findByIdAndUpdate(booking.vehicle, {
// // //           status: "active",
// // //           isListed: true,
// // //         });
// // //         console.log("✅ User vehicle status updated to active (available for new bookings)");
// // //       } else {
// // //         await Vehicle.findByIdAndUpdate(booking.vehicle, {
// // //           status: "Available",
// // //         });
...
// //     } else if (status === "completed") {
// //       booking.endDate = new Date();
// //       // Reset vehicle status to active/available when booking is completed
// //       await resetVehicleStatus(booking.vehicle, booking.vehicleType);
// //     } else if (status === "cancelled") {
// //       // Reset vehicle status when booking is cancelled
// //       await resetVehicleStatus(booking.vehicle, booking.vehicleType);
// //     }
...
// // // Helper function to reset vehicle status after booking completion
// // async function resetVehicleStatus(vehicleId, vehicleType) {
// //   try {
// //     if (vehicleType === "user") {
// //       await UserVehicle.findByIdAndUpdate(vehicleId, {
// //         status: "active",
// //         isListed: true,
// //       });
// //       console.log(`✅ User vehicle ${vehicleId} status reset to active`);
// //     } else {
// //       await Vehicle.findByIdAndUpdate(vehicleId, {
// //         status: "Available",
// //       });
// //       console.log(`✅ Admin vehicle ${vehicleId} status reset to Available`);
// //     }
// //     return true;
// //   } catch (error) {
...
// //     // Reset vehicle status before deleting booking
// //     await resetVehicleStatus(booking.vehicle, booking.vehicleType);
...
// // Approve booking (admin) - Sets vehicle to BOOKED but keeps isListed true
// export const approveBooking = async (req, res) => {
//   try {
//     const { id } = req.params;
//     const adminId = req.user.id;
...
//     // Update vehicle status - KEEP isListed as true
//     if (booking.vehicleType === "user") {
//       try {
//         await UserVehicle.findByIdAndUpdate(booking.vehicle, {
//           status: "booked",
//           isListed: true, // Keep as true so vehicle still appears in listings
//         });
//         console.log("✅ User vehicle status updated to BOOKED (still listed)");
//       } catch (error) {
//         console.error("Error updating user vehicle status:", error);
//       }
//     } else {
...
//     } else if (status === "completed") {
//       booking.endDate = new Date();
//       // Reset vehicle status when booking is completed
//       await resetVehicleStatus(booking.vehicle, booking.vehicleType);
//     } else if (status === "cancelled") {
//       // Reset vehicle status when booking is cancelled
//       await resetVehicleStatus(booking.vehicle, booking.vehicleType);
