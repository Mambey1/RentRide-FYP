...
//   }
// };
// // Add this function to authController.js (after existing functions)
...
export const loginUser = async (req, res) => {
  try {
    ...
    if (user.isBlocked) {
      return res.status(403).json({
        success: false,
        message: `Your account has been blocked. Reason: ${user.blockedReason || "Violation of terms"}. Please contact support.`,
        isBlocked: true,
      });
    }
