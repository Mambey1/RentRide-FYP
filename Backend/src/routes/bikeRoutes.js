...
// ── PROTECTED USER ROUTES ─────────────────────────────────────────────────────
// IMPORTANT: Static sub-paths MUST come BEFORE /:id to avoid Express
// treating "bookings" or "admin" as an :id param.

router.post("/bookings", protect, createBikeBooking);
router.get("/bookings/my-bookings", protect, getUserBikeBookings);
router.get("/bookings/:id", protect, getBikeBookingById); // ← single booking by ID
