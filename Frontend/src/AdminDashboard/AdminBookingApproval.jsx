...
//                         <div className="flex items-center gap-2">
//                           {getFileIcon(
//                             selectedDocuments.citizenshipFront.mimetype,
//                           )}
//                           <p className="font-medium">Front Side</p>
//                         </div>
//                         <button
//                           onClick={() =>
//                             openImageViewer(
//                               `http://localhost:5000${selectedDocuments.citizenshipFront.url}`,
//                             )
//                           }
//                           className="text-blue-600 hover:text-blue-700 text-sm flex items-center gap-1"
//                         >
...
//                         </button>
//                       </div>
//                       {selectedDocuments.citizenshipFront.mimetype?.startsWith(
//                         "image/",
//                       ) ? (
//                         <div
//                           className="mt-2 cursor-pointer overflow-hidden rounded-lg border border-gray-200 bg-white"
...
//                           <FaFilePdf className="text-red-500 text-5xl mx-auto mb-2" />
//                           <p className="text-sm text-gray-600">
//                             {selectedDocuments.citizenshipFront.originalName}
//                           </p>
//                           <a
//                             href={`http://localhost:5000${selectedDocuments.citizenshipFront.url}`}
//                             target="_blank"
...
//                         Uploaded:{" "}
//                         {new Date(
//                           selectedDocuments.citizenshipFront.uploadedAt,
//                         ).toLocaleDateString()}
//                       </p>
//                     </div>
//                   )}
...
//                         <div className="flex items-center gap-2">
//                           {getFileIcon(
//                             selectedDocuments.citizenshipBack.mimetype,
//                           )}
//                           <p className="font-medium">Back Side</p>
//                         </div>
//                         <button
//                           onClick={() =>
//                             openImageViewer(
//                               `http://localhost:5000${selectedDocuments.citizenshipBack.url}`,
//                             )
//                           }
//                           className="text-blue-600 hover:text-blue-700 text-sm flex items-center gap-1"
//                         >
...
//                         </button>
//                       </div>
//                       {selectedDocuments.citizenshipBack.mimetype?.startsWith(
//                         "image/",
//                       ) ? (
//                         <div
//                           className="mt-2 cursor-pointer overflow-hidden rounded-lg border border-gray-200 bg-white"
...
//                           <FaFilePdf className="text-red-500 text-5xl mx-auto mb-2" />
//                           <p className="text-sm text-gray-600">
//                             {selectedDocuments.citizenshipBack.originalName}
//                           </p>
//                           <a
//                             href={`http://localhost:5000${selectedDocuments.citizenshipBack.url}`}
//                             target="_blank"
...
//                         Uploaded:{" "}
//                         {new Date(
//                           selectedDocuments.citizenshipBack.uploadedAt,
//                         ).toLocaleDateString()}
//                       </p>
//                     </div>
//                   )}
...
//                           <div className="flex items-center gap-2">
//                             {getFileIcon(
//                               selectedDocuments.licenseFront.mimetype,
//                             )}
//                             <p className="font-medium">Front Side</p>
//                           </div>
//                           <button
//                             onClick={() =>
//                               openImageViewer(
//                                 `http://localhost:5000${selectedDocuments.licenseFront.url}`,
//                               )
//                             }
//                             className="text-blue-600 hover:text-blue-700 text-sm flex items-center gap-1"
//                           >
...
//                           </button>
//                         </div>
//                         {selectedDocuments.licenseFront.mimetype?.startsWith(
//                           "image/",
//                         ) ? (
//                           <div
//                             className="mt-2 cursor-pointer overflow-hidden rounded-lg border border-gray-200 bg-white"
...
//                             <FaFilePdf className="text-red-500 text-5xl mx-auto mb-2" />
//                             <p className="text-sm text-gray-600">
//                               {selectedDocuments.licenseFront.originalName}
//                             </p>
//                             <a
//                               href={`http://localhost:5000${selectedDocuments.licenseFront.url}`}
//                               target="_blank"
...
//                           Uploaded:{" "}
//                           {new Date(
//                             selectedDocuments.licenseFront.uploadedAt,
//                           ).toLocaleDateString()}
//                         </p>
//                       </div>
//                     )}
...
//                           <div className="flex items-center gap-2">
//                             {getFileIcon(
//                               selectedDocuments.licenseBack.mimetype,
//                             )}
//                             <p className="font-medium">Back Side</p>
//                           </div>
//                           <button
//                             onClick={() =>
//                               openImageViewer(
//                                 `http://localhost:5000${selectedDocuments.licenseBack.url}`,
//                               )
//                             }
//                             className="text-blue-600 hover:text-blue-700 text-sm flex items-center gap-1"
//                           >
...
//                           </button>
//                         </div>
//                         {selectedDocuments.licenseBack.mimetype?.startsWith(
//                           "image/",
//                         ) ? (
//                           <div
//                             className="mt-2 cursor-pointer overflow-hidden rounded-lg border border-gray-200 bg-white"
...
//                             <FaFilePdf className="text-red-500 text-5xl mx-auto mb-2" />
//                             <p className="text-sm text-gray-600">
//                               {selectedDocuments.licenseBack.originalName}
//                             </p>
//                             <a
//                               href={`http://localhost:5000${selectedDocuments.licenseBack.url}`}
//                               target="_blank"
...
//                           Uploaded:{" "}
//                           {new Date(
//                             selectedDocuments.licenseBack.uploadedAt,
//                           ).toLocaleDateString()}
//                         </p>
//                       </div>
//                     )}
...
//                   <p className="text-sm text-gray-500 mt-1">
//                     Verified on:{" "}
//                     {new Date(selectedDocuments.verifiedAt).toLocaleString()}
//                   </p>
//                 )}
//               </div>
//             </div>
                          ...
                          <button
                            onClick={() =>
                              showConfirmation(
                                ...
                                booking._id,
                                "Approve Booking",
                                `Are you sure you want to approve this booking for ${booking.vehicle?.carName}?`,
                                "approve",
                              )
                            }
                            className="p-2 text-green-600 hover:bg-green-50 rounded-lg transition"
          ...
          <div className="bg-white rounded-xl shadow-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-800 mb-3 flex items-center gap-2">
                    <FaFileAlt className="text-blue-600" /> Booking Information
                  </h4>
                  <div className="space-y-2">
                    <p>
                      <span className="text-gray-600">Booking ID:</span>{" "}
              ...
              {selectedBooking.status === "cancelled" && (
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-8">
                  <h4 className="font-semibold text-red-800 mb-3 flex items-center gap-2">
                    <FaTimesCircle className="text-red-600" /> Cancellation
                    Information
                  </h4>
                  <div className="space-y-2">
                    <p>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-8">
                <h4 className="font-semibold text-gray-800 mb-3 flex items-center gap-2">
                  <FaRupeeSign className="text-blue-600" /> Pricing Breakdown
                </h4>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-gray-600">
                  ...
                  <button
                    onClick={() =>
                      showConfirmation(
                        ...
                        selectedBooking._id,
                        "Approve Booking",
                        `Are you sure you want to approve this booking for ${selectedBooking.vehicle?.carName}?`,
                        "approve",
                      )
                    }
                    className="px-6 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition font-medium"
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-500">
                    Booking:{" "}
                    {selectedDocuments.bookingId?.confirmationCode || "N/A"}
                  </span>
                </div>
                <button
                  onClick={() => setShowDocumentsModal(false)}
                    ...
                    <div className="border rounded-xl p-4 bg-gray-50 hover:shadow-md transition">
                      ...
                      {selectedDocuments.passportPhoto.mimetype?.startsWith(
                        ...
                        <div className="mt-2 p-8 bg-white rounded-lg border border-gray-200 text-center">
                          <FaFilePdf className="text-red-500 text-5xl mx-auto mb-2" />
                          <p className="text-sm text-gray-600">
                            {selectedDocuments.passportPhoto.originalName}
                          </p>
                          <a
                      ...
                      <p className="text-xs text-gray-500 mt-2">
                        Uploaded:{" "}
                        {new Date(
                          selectedDocuments.passportPhoto.uploadedAt,
                        ).toLocaleDateString()}
                      </p>
                    </div>
                  </div>
