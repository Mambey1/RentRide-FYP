...
// // Separate import to avoid duplicate alias conflict
// import { FaIdCard as FaCitizenship } from "react-icons/fa";
...
//       on_hold: d.filter((v) => v?.status === "on_hold").length,
//     });
//   };
...
//                 customer payment. They will be released automatically after 24
//                 hours if payment is not received.
//               </p>
//             </div>
//           </div>
//           <button
...
//                   <tr
//                     key={vehicle._id}
//                     className={`hover:bg-gray-50 transition ${vehicle.status === "on_hold" ? "bg-amber-50/30" : ""}`}
//                   >
//                     <td className="px-6 py-4">
//                       <div className="flex items-center gap-3">
//                         {vehicle.vehiclePhotos?.[0] ? (
...
//                                   vehicle._id,
//                                   "Approve Vehicle Listing",
//                                   `Approve "${vehicle.carName}"? This vehicle will be listed for rent.`,
//                                   "approve",
//                                 )
//                               }
//                               className="p-2 text-green-600 hover:bg-green-50 rounded-lg transition"
...
//                                 `Release the hold on "${vehicle.carName}" and set it back to active? This will cancel any pending payment.`,
//                                 "reset",
//                               )
//                             }
...
//                                   vehicle._id,
//                                   "Delete Vehicle Permanently",
//                                   `Permanently delete "${vehicle.carName}"? This cannot be undone.`,
//                                   "delete",
//                                 )
//                               }
//                               className="p-2 text-red-600 hover:bg-red-50 rounded-lg transition"
...
//             </div>
//             <div className="p-6">
//               {/* On Hold alert inside modal */}
//               {selectedVehicle.status === "on_hold" &&
...
//                         </strong>
//                         . The vehicle will be released automatically if payment
//                         is not received.
//                       </p>
//                     </div>
//                   </div>
...
//                     [
//                       "Address",
//                       `${selectedVehicle.address}, ${selectedVehicle.city}, ${selectedVehicle.district}`,
//                     ],
//                   ].map(([label, value]) => (
//                     <div key={label}>
//                       <p className="text-sm text-gray-500">{label}</p>
...
//                           selectedVehicle._id,
//                           "Release Hold",
//                           `Release hold on "${selectedVehicle.carName}" and set to active?`,
//                           "reset",
//                         )
//                       }
