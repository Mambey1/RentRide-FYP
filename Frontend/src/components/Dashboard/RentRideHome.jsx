...
const RentRideHome = () => {
  ...
  const formatPrice = (price) => `रु ${price?.toLocaleString() || 0}`;
    ...
    return (
      ...
      >
        ...
        <div className="h-56 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 flex-shrink-0">
          <motion.img
            src={imageUrl || "https://images.unsplash.com/photo-1560958089-b8a1929cea89"}
            alt={vehicle.carName}
            className="w-full h-full object-cover"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-sm">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:block flex-1 max-w-xl mx-8">
              <div className="relative">
                ...
                <input
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-12 pr-4 py-3 bg-gray-100 border-0 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <button
                className="hidden md:block px-6 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:shadow-lg"
                onClick={() => navigate("/profiledetails")}
              >
                Book Now
              </button>
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        const avatar = document.createElement("div");
                        avatar.className =
                          "w-10 h-10 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold text-lg cursor-pointer";
                        avatar.textContent = getUserInitial();
                        parent.innerHTML = "";
                        parent.appendChild(avatar);
                      }
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900 to-pink-900 text-white">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent z-10"></div>
          <div
            className="absolute inset-0 z-0"
        ...
        <div className="container mx-auto px-6 py-24 md:py-32 relative z-20">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              Drive Your <span className="text-pink-400">Dream Car</span> in
              Kathmandu
            </h1>
            <p className="text-xl md:text-2xl mb-10 text-gray-200 max-w-xl">
              Experience luxury and convenience with our premium car rental
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-xl hover:shadow-2xl transition-all"
              >
                Explore Cars
              </button>
              <button
          ...
          {!loading && !error && filteredVehicles.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {filteredVehicles.map((vehicle, index) => (
                <CarCard key={vehicle._id} vehicle={vehicle} index={index} />
              ))}
            </div>
          )}
      ...
      <section className="py-20 bg-gradient-to-r from-purple-900 to-pink-900">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => navigate("/profiledetails")}
              className="px-10 py-4 bg-white text-purple-600 font-bold rounded-xl hover:shadow-2xl transition-all"
            >
              Start Booking Now
            </button>
            <button className="px-10 py-4 bg-transparent border-2 border-white text-white font-bold rounded-xl hover:bg-white/10">
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
                <div className="flex">
                  <input
                    ...
                    value={subscriberEmail}
                    onChange={(e) => setSubscriberEmail(e.target.value)}
                    className="flex-1 px-4 py-3 bg-gray-800 border-0 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                  <button
                    type="submit"
                    className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-r-lg hover:opacity-90 transition-opacity"
                  >
                    <FaEnvelope />
                  </button>
                </div>
                {subscribeMessage && (
                  <p
                    className={`text-sm ${subscribeStatus === "success" ? "text-green-400" : subscribeStatus === "error" ? "text-red-400" : "text-purple-400"}`}
                  >
                    {subscribeMessage}
                  </p>
                )}
