...
// //                 <li>
// //                   <a href="#vehicles" className="text-gray-400 hover:text-white transition-all duration-200 text-sm block">
// //                     Browse Cars
// //                   </a>
// //                 </li>
// //                 <li>
// //                   <a href="#how-it-works" className="text-gray-400 hover:text-white transition-all duration-200 text-sm block">
// //                     How It Works
// //                   </a>
// //                 </li>
// //                 <li>
// //                   <a href="#contact" className="text-gray-400 hover:text-white transition-all duration-200 text-sm block">
// //                     About Us
// //                   </a>
// //                 </li>
// //                 <li>
...
>>>>>>> d955bad (feat:Added message sytem for admin to message any user from UMS)
// import React, { useState, useEffect } from "react";
// import {
//   FaCar,
//   FaCheckCircle,
...
//   const [subscribeStatus, setSubscribeStatus] = useState(null);
//   const [activeTab, setActiveTab] = useState("cars");
//   const [bikeCount, setBikeCount] = useState(null); // ← bike count for tab badge
...
//       <section
//         id="how-it-works"
//         className="pt-28 pb-20 bg-gradient-to-b from-white to-gray-50"
//       >
//         <div className="container mx-auto px-6">
//           <div className="text-center mb-12">
//             <span className="inline-block px-4 py-1.5 bg-blue-100 text-blue-600 rounded-full text-sm font-semibold mb-4">
...
//                 />
//                 <span>Bikes</span>
//                 {/* ── Bike count badge — populated via onCountReady callback ── */}
//                 {bikeCount !== null && (
//                   <span
//                     className={`px-2 py-0.5 rounded-full text-xs font-semibold ${
//                       activeTab === "bikes"
