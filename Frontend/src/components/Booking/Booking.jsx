...
// //                       <p className="text-xs text-white/80">
// //                         {selectedReviewer
// //                           ? `Replied to ${vehicleDetails?.carName} review`
...
//                           )}
//                           Chat with{" "}
//                           {vehicleDetails.source === "user" ? "Owner" : "Admin"}
//                         </button>
//                       </div>
//                     </div>
//                     <div className="mb-8">
...
//       {showChatModal && (
//         <div
//           className={`fixed inset-0 z-[100] ${isFullScreen ? "p-0" : "p-4"}`}
//         >
//           <div
//             className="absolute inset-0 bg-black/60 backdrop-blur-sm"
//             onClick={() => {
//               if (!isFullScreen) setShowChatModal(false);
//             }}
//           ></div>
//           <div
//             className={`absolute inset-0 flex items-center justify-center ${isFullScreen ? "p-0" : "p-4"}`}
//           >
//             <div
//               className={`bg-white rounded-2xl flex flex-col shadow-2xl overflow-hidden transition-all duration-300 ${isFullScreen ? "w-full h-full rounded-none" : "w-full max-w-md h-[550px]"}`}
//             >
//               {/* Chat Header */}
//               <div className="flex items-center justify-between p-4 border-b bg-gradient-to-r from-blue-600 to-purple-600 text-white">
//                 <div className="flex items-center gap-3">
