...
//             className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-xs font-medium mb-4 hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-2"
//           >
//             <img src={googleLogo} alt="Google" className="w-4 h-4" />
//             Continue with Google
//           </button>
...
const SignUp = () => {
  ...
  // ✅ Google signup — token storage handled by GoogleCallback page
  const handleGoogleSignup = () => {
    if (loading) return;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4 relative overflow-hidden">
      <ToastContainer position="top-right" autoClose={3000} hideProgressBar={false}
        newestOnTop closeOnClick pauseOnFocusLoss draggable pauseOnHover theme="light" />
      ...
      <div className="w-full max-w-5xl bg-white rounded-2xl shadow-xl flex overflow-hidden border border-gray-100 relative z-10 h-[85vh]">
        ...
        <div className="w-1/2 px-8 py-6 flex flex-col overflow-y-auto">
          ...
          <button
            onClick={handleGoogleSignup}
            disabled={loading}
            className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-xs font-medium mb-4 hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <img src={googleLogo} alt="Google" className="w-4 h-4" />
            Continue with Google
          </button>
          ...
          <div className="flex items-center mb-4">
            <div className="flex-1 h-px bg-gray-200"></div>
            <span className="px-3 text-xs text-gray-500">or sign up with email</span>
            <div className="flex-1 h-px bg-gray-200"></div>
          </div>
          ...
          <div className="mb-4">
            <label className="flex items-start gap-2 cursor-pointer">
              ...
              <span className="text-xs text-gray-600 leading-tight select-none">
                I agree to the{" "}
                <button className="text-blue-600 font-medium hover:text-blue-700">Terms of Service</button>{" "}
                and{" "}
                <button className="text-blue-600 font-medium hover:text-blue-700">Privacy Policy</button>
              </span>
            </label>
          </div>
          ...
          <button onClick={handleSignup} disabled={loading}
            className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-2.5 rounded-lg shadow hover:shadow-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm flex items-center justify-center gap-2 mb-4">
            {loading ? (
              <>
                <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
                Creating Account...
          ...
          <div className="p-3 bg-blue-50 rounded-lg border border-blue-100">
            <div className="flex items-start gap-2">
              <FaEnvelope className="text-blue-600 text-sm mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-xs font-medium text-gray-900">Email Verification Required</p>
                <p className="text-xs text-gray-600">You'll receive a 6-digit OTP to verify your email</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Right Panel */}
        <div className="w-1/2 relative overflow-hidden">
          <img src={signupImage} alt="Driving" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-black/20 to-transparent"></div>
          <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
            <div className="bg-gradient-to-r from-white/10 to-transparent backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <h3 className="text-lg font-bold mb-2">Why Verify Your Email?</h3>
              <p className="text-white/90 text-xs mb-3">Email verification ensures the security of your account</p>
              <div className="space-y-1">
                {["Secure account recovery", "Booking confirmations", "Premium features access"].map((item) => (
